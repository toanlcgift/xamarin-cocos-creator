...
var s = new o.default.Vec3(), a = new o.default.Vec3(), l = cc.Vec3, h = function() {
function t() {
...
var h = cc.Node._LocalDirtyFlag.PHYSICS_SCALE, c = cc.Quat, u = cc.Vec3, p = cc.js.array.fastRemoveAt, d = new u(), y = new c(), f = [], v = {
...
c.copy(this.body.quaternion, e.__wrot);
if (e._localMatDirty & h) for (var o = e.__wscale, n = 0; n < this.shapes.length; n++) this.shapes[n].setScale(o);
...
(0, r.updateWorldRT)(this.node, d, y);
}
};
e.destroy = function() {
...
var c = cc.Vec3, u = cc.js.array.fastRemoveAt, p = function() {
h(t, [ {
key: "world",
get: function() {
return this._world;
...
f(t, e.maxDistance);
(0, n.toCannonRaycastOptions)(v, e);
return this._world.raycastAll(d, y, v, function(t) {
var e = i.add();
...
i.CannonWorld = p;
var d = new o.default.Vec3(), y = new o.default.Vec3();
function f(t, e) {
c.copy(d, t.o);
t.computeHit(y, e);
}
...
var h = cc.Vec3, c = new h(), u = function(t) {
l(e, t);
a(e, [ {
key: "boxCollider",
get: function() {
...
var S = cc._decorator, E = S.ccclass, M = S.executeInEditMode, A = S.executionOrder, C = S.menu, z = S.property, R = S.requireComponent, P = S.disallowMultiple, T = cc.Vec3, F = (o = E("cc.ConstantForce"), 
n = A(98), r = R(m.RigidBody3D), s = C("i18n:MAIN_MENU.component.physics/Constant Force 3D"), 
a = z({
displayOrder: 0
}), l = z({
displayOrder: 1
...
displayOrder: 3
}), o(u = n(u = r(u = s(u = P(u = M(u = (p = function(t) {
_(e, t);
function e() {
...
var P = cc._decorator, T = P.ccclass, F = P.disallowMultiple, q = P.executeInEditMode, V = P.executionOrder, I = P.menu, O = P.property, k = cc.Vec3, j = (o = T("cc.RigidBody3D"), 
n = V(99), r = I("i18n:MAIN_MENU.component.physics/Rigid Body 3D"), s = O({
displayOrder: 0
}), a = O({
displayOrder: 1
}), l = O({
...
displayOrder: 7
}), o(y = n(y = r(y = q(y = F(y = (R((f = function(t) {
z(e, t);
C(e, [ {
key: "allowSleep",
get: function() {
...
}), m = R(f.prototype, "_linearDamping", [ O ], {
configurable: !0,
enumerable: !0,
writable: !0,
initializer: function() {
...
}), g = R(f.prototype, "_angularDamping", [ O ], {
configurable: !0,
enumerable: !0,
writable: !0,
initializer: function() {
...
}), w = R(f.prototype, "_fixedRotation", [ O ], {
configurable: !0,
enumerable: !0,
writable: !0,
initializer: function() {
...
}), b = R(f.prototype, "_isKinematic", [ O ], {
configurable: !0,
enumerable: !0,
writable: !0,
initializer: function() {
...
}), _ = R(f.prototype, "_linearFactor", [ O ], {
configurable: !0,
enumerable: !0,
writable: !0,
initializer: function() {
...
}), B = R(f.prototype, "_angularFactor", [ O ], {
configurable: !0,
enumerable: !0,
writable: !0,
initializer: function() {
...
var g = cc._decorator, w = g.property, b = (0, g.ccclass)("cc.Physics3DManager")(o = (n = function() {
v(t, [ {
key: "enabled",
get: function() {
...
var i = s, o = i[0], n = i[1], r = i[2], a = i[3], l = i[4], h = i[5], c = i[6], u = i[7];
...
for (var i = l, o = h, n = c, r = t.length, s = 0; s !== r; s++) {
o[s] = t[s];
n[s] = e[s];
}
t.length = 0;
...
new n();
s.prototype.collisionPairs = function(t, e, i) {
for (var o = t.numObjects(), n = t.bodies, s = this.aabbMax, l = this.aabbMin, h = this.nx, c = this.ny, u = this.nz, p = c * u, d = u, y = 1, f = s.x, v = s.y, m = s.z, g = l.x, w = l.y, b = l.z, x = h / (f - g), _ = c / (v - w), B = u / (m - b), S = (f - g) / h, E = (v - w) / c, M = (m - b) / u, A = .5 * Math.sqrt(S * S + E * E + M * M), C = r.types, z = C.SPHERE, R = C.PLANE, P = (C.BOX, 
C.COMPOUND, C.CONVEXPOLYHEDRON, this.bins), T = this.binLengths, F = this.bins.length, q = 0; q !== F; q++) T[q] = 0;
var V = Math.ceil;
l = Math.min, s = Math.max;
function I(t, e, i, o, n, r, s) {
var a = (t - g) * x | 0, l = (e - w) * _ | 0, f = (i - b) * B | 0, v = V((o - g) * x), m = V((n - w) * _), S = V((r - b) * B);
a < 0 ? a = 0 : a >= h && (a = h - 1);
l < 0 ? l = 0 : l >= c && (l = c - 1);
f < 0 ? f = 0 : f >= u && (f = u - 1);
v < 0 ? v = 0 : v >= h && (v = h - 1);
...
m *= d;
S *= y;
for (var E = a *= p; E <= v; E += p) for (var M = l; M <= m; M += d) for (var A = f; A <= S; A += y) {
var C = E + M + A;
P[C][T[C]++] = s;
}
}
...
switch (O.type) {
case z:
var k = it.position.x, j = it.position.y, N = it.position.z, L = O.radius;
I(k - L, j - L, N - L, k + L, j + L, N + L, it);
break;

case R:
O.worldNormalNeedsUpdate && O.computeWorldNormal(it.quaternion);
var W = O.worldNormal, D = g + .5 * S - it.position.x, U = w + .5 * E - it.position.y, G = b + .5 * M - it.position.z, H = a;
H.set(D, U, G);
for (var Q = 0, X = 0; Q !== h; Q++, X += p, H.y = U, H.x += S) for (var Y = 0, K = 0; Y !== c; Y++, 
K += d, H.z = G, H.y += E) for (var Z = 0, J = 0; Z !== u; Z++, J += y, H.z += M) if (H.dot(W) < A) {
var $ = X + K + J;
P[$][T[$]++] = it;
}
break;
...
i.vsub(e, p);
t.vsub(e, d);
var n, r, s = O.dot(O), a = O.dot(p), l = O.dot(d), h = p.dot(p), c = p.dot(d);
...
if ((!i || t.collisionResponse) && 0 != (this.collisionFilterGroup & t.collisionFilterMask) && 0 != (t.collisionFilterGroup & this.collisionFilterMask)) for (var o = f, n = v, r = 0, s = t.shapes.length; r < s; r++) {
var a = t.shapes[r];
...
new o(), new o();
var m = new o(), g = new o(), w = new o(), b = new o();
new o(), new s();
h.prototype.intersectBox = function(t, e, i, o, n) {
return this.intersectConvex(t.convexPolyhedronRepresentation, e, i, o, n);
};
h.prototype[a.types.BOX] = h.prototype.intersectBox;
h.prototype.intersectPlane = function(t, e, i, n, r) {
var s = this.from, a = this.to, l = this._direction, h = new o(0, 0, 1);
e.vmult(h, h);
var c = new o();
s.vsub(i, c);
var u = c.dot(h);
...
h.prototype[a.types.PLANE] = h.prototype.intersectPlane;
h.prototype.getAABB = function(t) {
...
c = Math.min(c, p[0] + 1);
u = Math.min(u, p[1] + 1);
for (var y = a; y < c; y++) for (var f = h; f < u; f++) {
...
var r = this.from, s = this.to, a = t.radius, l = Math.pow(s.x - r.x, 2) + Math.pow(s.y - r.y, 2) + Math.pow(s.z - r.z, 2), h = 2 * ((s.x - r.x) * (r.x - i.x) + (s.y - r.y) * (r.y - i.y) + (s.z - r.z) * (r.z - i.z)), c = Math.pow(r.x - i.x, 2) + Math.pow(r.y - i.y, 2) + Math.pow(r.z - i.z, 2) - Math.pow(a, 2), u = Math.pow(h, 2) - 4 * l * c, p = E, d = M;
if (!(u < 0)) if (0 === u) {
r.lerp(s, u, p);
p.vsub(i, d);
d.normalize();
...
var A = new o(), C = (new o(), new o(), new o());
...
var S = l ? l[B] : B, E = h[S], M = u[S], z = e, R = i;
a.copy(c[E[0]]);
z.vmult(a, a);
a.vadd(R, a);
a.vsub(d, a);
...
var z = new o(), R = new o(), P = new o(), T = new o(), F = new o(), q = new o(), V = (new l(), 
[]), I = new r();
h.prototype.intersectTrimesh = function(t, e, i, o, n, s) {
var a = z, l = V, h = I, c = C, u = R, p = P, d = T, f = q, v = F, x = (s && s.faceList, 
...
t.getVertex(x[3 * O], g);
g.vsub(p, c);
var k = u.dot(a), j = a.dot(c) / k;
if (!(j < 0)) {
u.scale(j, m);
m.vadd(p, m);
t.getVertex(x[3 * O + 1], w);
t.getVertex(x[3 * O + 2], b);
var N = m.distanceSquared(p);
if (!(!y(m, w, g, b) && !y(m, g, w, b) || N > E)) {
r.vectorToWorldFrame(e, a, v);
r.pointToWorldFrame(i, e, m, f);
this.reportIntersection(v, f, n, o, O);
}
}
}
l.length = 0;
};
h.prototype[a.types.TRIMESH] = h.prototype.intersectTrimesh;
h.prototype.reportIntersection = function(t, e, i, o, n) {
...
t("../math/Vec3"));
function a(t, e, i) {
var a = "undefined" != typeof (i = i || {}).maxForce ? i.maxForce : 1e6, l = i.pivotA ? i.pivotA.clone() : new s(), h = i.pivotB ? i.pivotB.clone() : new s();
this.axisA = i.axisA ? i.axisA.clone() : new s();
this.axisB = i.axisB ? i.axisB.clone() : new s();
o.call(this, t, l, e, h, a);
this.collideConnected = !!i.collideConnected;
this.angle = "undefined" != typeof i.angle ? i.angle : 0;
var c = this.coneEquation = new n(t, e, i), u = this.twistEquation = new r(t, e, i);
...
var c = this.rotationalEquation1 = new n(t, e, i), u = this.rotationalEquation2 = new n(t, e, i), p = this.motorEquation = new r(t, e, a);
p.enabled = !1;
...
var l = new s(), h = new s();
a.prototype.update = function() {
var t = this.bodyA, e = this.bodyB, i = this.motorEquation, n = this.rotationalEquation1, r = this.rotationalEquation2, s = l, a = h, c = this.axisA, u = this.axisB;
o.prototype.update.call(this);
...
function s(t, e, i) {
var s = "undefined" != typeof (i = i || {}).maxForce ? i.maxForce : 1e6, a = new r(), l = new r(), h = new r();
...
var c = this.rotationalEquation1 = new n(t, e, i), u = this.rotationalEquation2 = new n(t, e, i), p = this.rotationalEquation3 = new n(t, e, i);
this.equations.push(c, u, p);
}
s.prototype = new o();
s.constructor = s;
...
var l = this.equationX = new n(t, i), h = this.equationY = new n(t, i), c = this.equationZ = new n(t, i);
...
var e = this.a, i = this.b, o = this.axisA, n = this.axisB, r = s, l = a, h = this.jacobianElementA, c = this.jacobianElementB;
o.cross(n, r);
n.cross(o, l);
h.rotational.copy(l);
c.rotational.copy(r);
...
r.prototype.computeB = function(t) {
var e = this.a, i = this.b, o = this.bi, n = this.bj, r = this.ri, h = this.rj, c = s, u = a, p = o.velocity, d = o.angularVelocity, y = (o.force, 
o.torque, n.velocity), f = n.angularVelocity, v = (n.force, n.torque, l), m = this.jacobianElementA, g = this.jacobianElementB, w = this.ni;
r.cross(w, c);
h.cross(w, u);
w.negate(m.spatial);
...
var h = new n(), c = new n(), u = new n(), p = new n(), d = new n();
r.prototype.getImpactVelocityAlongNormal = function() {
var t = h, e = c, i = u, o = p, n = d;
...
var t = this.jacobianElementA, e = this.jacobianElementB, i = this.bi, o = this.bj, n = i.force, r = i.torque, c = o.force, u = o.torque, p = i.invMassSolve, d = o.invMassSolve;
n.scale(p, s);
c.scale(d, a);
i.invInertiaWorldSolve.vmult(r, l);
o.invInertiaWorldSolve.vmult(u, h);
return t.multiplyVectors(s, l) + e.multiplyVectors(a, h);
};
var c = new n();
...
var s, a, l = 3, h = l;
do {
if (0 === n[(r = h - l) + 4 * r]) for (i = r + 1; i < h; i++) if (0 !== n[r + 4 * i]) {
s = 4;
do {
n[(a = 4 - s) + 4 * r] += n[a + 4 * i];
} while (--s);
...
n.prototype.vmult = function(t, e) {
e = e || new o();
var i = t.x, n = t.y, r = t.z, s = this.x, a = this.y, l = this.z, h = this.w, c = h * i + a * r - l * n, u = h * n + l * i - s * r, p = h * r + s * n - a * i, d = -s * i - a * n - l * r;
e.x = c * h + d * -s + u * -l - p * -a;
e.y = u * h + d * -a + p * -s - c * -l;
e.z = p * h + d * -l + c * -a - u * -s;
return e;
...
if (isNaN(i)) {
var c = r * r, u = s * s, p = a * a;
i = Math.atan2(2 * s * l - 2 * r * a, 1 - 2 * u - 2 * p);
o = Math.asin(2 * h);
n = Math.atan2(2 * r * l - 2 * s * a, 1 - 2 * c - 2 * p);
}
break;
...
o = o || "XYZ";
var n = Math.cos(t / 2), r = Math.cos(e / 2), s = Math.cos(i / 2), a = Math.sin(t / 2), l = Math.sin(e / 2), h = Math.sin(i / 2);
if ("XYZ" === o) {
this.x = a * r * s + n * l * h;
this.y = n * l * s - a * r * h;
this.z = n * r * h + a * l * s;
...
i = i || new n();
var o, r, s, a, l, h = this.x, c = this.y, u = this.z, p = this.w, d = t.x, y = t.y, f = t.z, v = t.w;
if ((r = h * d + c * y + u * f + p * v) < 0) {
r = -r;
d = -d;
y = -y;
f = -f;
...
t("../collision/AABB")), l = t("../shapes/Box"), h = t("../world/World");
function c(t) {
t = t || {};
o.apply(this);
this.id = c.idCounter++;
...
i[h].mult(s, r);
c.calculateWorldAABB(n, r, l.lowerBound, l.upperBound);
...
var e = l, i = h, o = c, r = this.wheelInfos[t];
...
c.cross(h, s[l]);
s[l].normalize();
M.sideImpulse = z(r, M.raycastResult.hitPointWorld, p, M.raycastResult.hitPointWorld, h);
M.sideImpulse *= 1;
}
}
this.sliding = !1;
...
for (l = 0; l < n; l++) {
var M = i[l], A = new o();
M.raycastResult.hitPointWorld.vsub(r.position, A);
if (0 !== M.forwardImpulse) {
var C = new o();
s[l].scale(M.forwardImpulse, C);
r.applyImpulse(C, A);
}
if (0 !== M.sideImpulse) {
...
r.vectorToLocalFrame(A, A);
A["xyz"[this.indexUpAxis]] *= M.rollInfluence;
r.vectorToWorldFrame(A, A);
r.applyImpulse(P, A);
P.scale(-1, P);
p.applyImpulse(P, R);
}
...
var m = new o(), g = new o(), w = new o();
function b(t, e, i, o, n) {
var r = 0, s = i, a = m, l = g, h = w;
t.getVelocityAtWorldPoint(s, a);
e.getVelocityAtWorldPoint(s, l);
a.vsub(l, h);
n < (r = -o.dot(h) * (1 / (E(t, i, o) + E(e, i, o)))) && (r = n);
r < -n && (r = -n);
return r;
}
...
var s = new o(), a = new o(), l = new o(), h = new o(), c = new o(), u = new o();
n.prototype.update = function() {
...
var r = new o(), s = new o(), a = new o(), l = new o(), h = new o(), c = new o(), u = new o(), p = new o(), d = new o(), y = new o(), f = new o();
n.prototype.applyForce = function() {
var t = this.stiffness, e = this.damping, i = this.restLength, o = this.bodyA, n = this.bodyB, v = r, m = s, g = a, w = l, b = f, x = h, _ = c, B = u, S = p, E = d, M = y;
...
n.angularVelocity.cross(S, b);
g.vadd(b, g);
o.angularVelocity.cross(B, b);
g.vsub(b, g);
m.mult(-t * (A - i) - e * g.dot(m), w);
o.force.vsub(w, o.force);
n.force.vadd(w, n.force);
B.cross(w, E);
S.cross(w, M);
...
e.hitPointWorld.vsub(t.position, h);
t.getVelocityAtWorldPoint(h, l);
...
var u = new n(), p = new n(), d = new n(), y = new n(), f = new n(), v = new n();
s.prototype.findSeparatingAxis = function(t, e, i, o, n, r, s, a) {
var l = u, h = p, c = d, m = y, g = f, w = v, b = Number.MAX_VALUE;
...
var i = b.x - w.x, o = b.y - w.y, n = b.z - w.z;
...
var x = new n(), _ = new n(), B = new n(), S = new n(), E = new n(), M = new n(), A = new n(), C = new n();
...
var z = this.faces[m];
z.connectedFaces = [];
for (var R = 0; R < this.faces.length; R++) for (var P = 0; P < this.faces[R].length; P++) -1 !== z.indexOf(this.faces[R][P]) && R !== m && -1 === z.connectedFaces.indexOf(R) && z.connectedFaces.push(R);
f.length;
for (var T = z.length, F = 0; F < T; F++) {
var q = this.vertices[z[F]], V = this.vertices[z[(F + 1) % T]];
q.vsub(V, l);
h.copy(l);
i.vmult(h, h);
e.vadd(h, h);
...
e.vadd(p, p);
p.dot(u);
var I = z.connectedFaces[F];
d.copy(this.faceNormals[I]);
var O = this.getPlaneConstantOfFace(I);
y.copy(d);
i.vmult(y, y);
var k = O - y.dot(e);
...
y.copy(d);
i.vmult(y, y);
for (k = O - y.dot(e), R = 0; R < f.length; R++) {
var j = y.dot(f[R]) + k;
j <= n && (j = n);
if (j <= r) {
var N = f[R];
...
var R = new n(), P = new n(), T = new n();
s.prototype.pointIsInside = function(t) {
var e = this.vertices.length, i = this.vertices, o = this.faces, n = this.faceNormals, r = this.faces.length, s = R;
...
var s = t.vertices.length, a = F, l = 0, h = 0, c = q, u = t.vertices;
c.setZero();
r.vectorToLocalFrame(i, o, e, a);
r.pointToLocalFrame(i, o, c, c);
var p = c.dot(a);
h = l = u[0].dot(a);
for (var d = 1; d < s; d++) {
var y = u[d].dot(a);
...
function r(t, e, i, r) {
var s = r, a = [], l = [], h = [], c = [], u = [], p = Math.cos, d = Math.sin;
a.push(new o(e * p(0), e * d(0), .5 * -i));
c.push(0);
a.push(new o(t * p(0), t * d(0), .5 * i));
u.push(1);
for (var y = 0; y < s; y++) {
var f = 2 * Math.PI / s * (y + 1), v = 2 * Math.PI / s * (y + .5);
if (y < s - 1) {
a.push(new o(e * p(f), e * d(f), .5 * -i));
c.push(2 * y + 2);
a.push(new o(t * p(f), t * d(f), .5 * i));
u.push(2 * y + 3);
h.push([ 2 * y + 2, 2 * y + 3, 2 * y + 1, 2 * y ]);
} else h.push([ 0, 1, 2 * y + 1, 2 * y ]);
(s % 2 == 1 || y < s / 2) && l.push(new o(p(v), d(v), 0));
}
h.push(u);
l.push(new o(0, 0, 1));
var m = [];
...
var l = [], h = new r(), c = new r(), u = new r(), p = new r();
a.prototype.getTriangleAt = function(t, e, i, o, n, r) {
var s = l;
this.getIndexOfPosition(t, e, s, i);
var a = s[0], h = s[1], c = this.data;
if (i) {
a = Math.min(c.length - 2, Math.max(0, a));
h = Math.min(c[0].length - 2, Math.max(0, h));
}
var u = this.elementSize, p = Math.pow(t / u - a, 2) + Math.pow(e / u - h, 2) > Math.pow(t / u - (a + 1), 2) + Math.pow(e / u - (h + 1), 2);
this.getTriangle(a, h, p, o, n, r);
return p;
};
var d = new r(), y = new r(), f = new r(), v = new r(), m = new r();
a.prototype.getNormalAt = function(t, e, i, o) {
var n = d, r = y, s = f, a = v, l = m;
...
var o = this.data, n = c, r = u, s = p, a = l;
...
var c = 3 * h;
this._getUnscaledVertex(this.indices[c], o);
this._getUnscaledVertex(this.indices[c + 1], r);
...
o = o || 6;
n = n || 2 * Math.PI;
for (var r = [], s = [], a = 0; a <= i; a++) for (var h = 0; h <= o; h++) {
var c = h / o * n, u = a / i * Math.PI * 2, p = (t + e * Math.cos(u)) * Math.cos(c), d = (t + e * Math.cos(u)) * Math.sin(c), y = e * Math.sin(u);
r.push(p, d, y);
}
for (a = 1; a <= i; a++) for (h = 1; h <= o; h++) {
var f = (o + 1) * a + h - 1, v = (o + 1) * (a - 1) + h - 1, m = (o + 1) * (a - 1) + h, g = (o + 1) * a + h;
s.push(f, v, g);
s.push(v, m, g);
}
return new l(r, s);
...
var r = [], s = [], a = [];
n.prototype.solve = function(t, e) {
var i, o, n, l, h, c = 0, u = this.iterations, p = this.tolerance * this.tolerance, d = this.equations, y = d.length, f = e.bodies, v = f.length, m = t;
...
i = b[E];
o = w[E];
(h = x[E]) + (n = o * (i - _.computeGWlambda() - _.eps * h)) < _.minForce ? n = _.minForce - h : h + n > _.maxForce && (n = _.maxForce - h);
x[E] += n;
l += n > 0 ? n : -n;
_.addToWlambda(n);
}
...
for (g = 0; g !== v; g++) {
var M, A = (M = f[g]).velocity, C = M.angularVelocity;
...
t.visited = !0;
e(t, i, o);
for (;u.length; ) for (var n, r = u.pop(); n = c(r.children); ) {
n.visited = !0;
e(n, i, o);
u.push(n);
}
...
for (var g = 0; g !== h; g++) {
var w = r[g], b = (v = n.indexOf(w.bi), n.indexOf(w.bj)), x = i[v], _ = i[b];
x.children.push(_);
x.eqs.push(w);
_.children.push(x);
_.eqs.push(w);
...
56: [ function(t, e, i) {
e.exports = d;
var o = t("../collision/AABB"), n = t("../objects/Body"), r = t("../shapes/Shape"), s = t("../collision/Ray"), a = t("../math/Vec3"), l = t("../math/Transform"), h = (t("../shapes/ConvexPolyhedron"), 
t("../math/Quaternion")), c = (t("../solver/Solver"), t("../utils/Vec3Pool")), u = t("../equations/ContactEquation"), p = t("../equations/FrictionEquation");
function d(t) {
...
var m = new a(), g = new a(), w = new h(), b = new h();
...
if (A) {
if ((B.type < E.type ? A.call(this, B, E, c, u, l, h, y, f, B, E, x) : A.call(this, E, B, u, c, h, l, f, y, B, E, x)) && x) {
...
var S = new a(), E = new a(), M = (new a(), new a()), A = new a(), C = new a(), z = new a(), R = new a(), P = new a(), T = new a(), F = new a(), q = new a(), V = new a(), I = new a(), O = new o(), k = [];
d.prototype[r.types.SPHERE | r.types.TRIMESH] = d.prototype.sphereTrimesh = function(t, e, i, o, n, r, a, h, c, u, p) {
var d = C, y = z, f = R, v = P, m = T, g = F, w = O, b = A, x = E, _ = k;
l.pointToLocalFrame(o, r, i, m);
var B = t.radius;
w.lowerBound.set(m.x - B, m.y - B, m.z - B);
w.upperBound.set(m.x + B, m.y + B, m.z + B);
e.getTrianglesInAABB(w, _);
for (var j = M, N = t.radius * t.radius, L = 0; L < _.length; L++) for (var W = 0; W < 3; W++) {
e.getVertex(e.indices[3 * _[L] + W], j);
j.vsub(m, x);
if (x.norm2() <= N) {
b.copy(j);
l.pointToWorldFrame(o, r, b, j);
j.vsub(i, x);
if (p) return !0;
(G = this.createContactEquation(a, h, t, e, c, u)).ni.copy(x);
G.ni.normalize();
G.ri.copy(G.ni);
...
for (var H = q, Q = V, X = I, Y = S, K = (L = 0, _.length); L !== K; L++) {
...
var j = new a(), N = new a(), L = new a(), W = new a(), D = new a();
...
C.copy(p[(B + 1) % 3]);
z.copy(p[(B + 2) % 3]);
var R = C.norm(), P = z.norm();
C.normalize();
z.normalize();
var T = X.dot(C), F = X.dot(z);
if (T < R && T > -R && F < P && F > -P) {
...
for (var I = u.get(), O = $, k = 0; 2 !== k && !y; k++) for (var j = 0; 2 !== j && !y; j++) for (var N = 0; 2 !== N && !y; N++) {
I.set(0, 0, 0);
k ? I.vadd(p[0], I) : I.vsub(p[0], I);
j ? I.vadd(p[1], I) : I.vsub(p[1], I);
N ? I.vadd(p[2], I) : I.vsub(p[2], I);
o.vadd(I, O);
O.vsub(i, O);
if (O.norm2() < d * d) {
if (c) return !0;
y = !0;
(V = this.createContactEquation(s, a, t, e, l, h)).ri.copy(O);
V.ri.normalize();
V.ni.copy(V.ri);
V.ri.mult(d, V.ri);
V.rj.copy(I);
...
u.release(I);
I = null;
var L = u.get(), W = u.get(), D = (V = u.get(), u.get()), U = (q = u.get(), p.length);
for (k = 0; k !== U && !y; k++) for (j = 0; j !== U && !y; j++) if (k % 3 != j % 3) {
p[j].cross(p[k], L);
L.normalize();
p[k].vadd(p[j], W);
V.copy(i);
...
var ot = new a(), nt = new a(), rt = new a(), st = new a(), at = new a(), lt = new a(), ht = new a(), ct = new a(), ut = new a(), pt = new a();
...
this.createFrictionEquationsFromContact(q, this.frictionResult);
P = 0;
for (var O = R.length; P !== O; P++) u.release(R[P]);
return;
}
for (P = 0; P !== B.length; P++) {
var k = u.get(), j = u.get();
r.vmult(y[B[(P + 1) % B.length]], k);
r.vmult(y[B[(P + 2) % B.length]], j);
o.vadd(k, k);
o.vadd(j, j);
var N = nt;
j.vsub(k, N);
...
this.result.push(q);
this.createFrictionEquationsFromContact(q, this.frictionResult);
for (P = 0, O = R.length; P !== O; P++) u.release(R[P]);
u.release(k);
u.release(j);
u.release(W);
u.release(G);
...
var dt = new a(), yt = new a(), ft = new a(), vt = new a();
...
if (p.dot(y) <= 0) {
if (c) return !0;
var v = this.createContactEquation(s, a, t, e, l, h), m = vt;
p.mult(p.dot(y), m);
u.vsub(m, m);
m.vsub(i, v.ri);
v.ni.copy(p);
...
var wt = new a(), bt = new a(), xt = new a();
...
l.pointToWorldFrame(o, r, e.pillarOffset, f);
i.distanceTo(f) < e.pillarConvex.boundingSphereRadius + t.boundingSphereRadius && (A = this.convexConvex(t, e.pillarConvex, i, f, n, r, s, a, null, null, u, v, null));
if (u && A) return !0;
...
e.getConvexTrianglePillar(E, M, !1);
l.pointToWorldFrame(o, r, e.pillarOffset, f);
i.distanceTo(f) < e.pillarConvex.boundingSphereRadius + t.boundingSphereRadius && (C = this.sphereConvex(t, e.pillarConvex, i, f, n, r, s, a, t, e, u));
if (u && C) return !0;
e.getConvexTrianglePillar(E, M, !0);
l.pointToWorldFrame(o, r, e.pillarOffset, f);
i.distanceTo(f) < e.pillarConvex.boundingSphereRadius + t.boundingSphereRadius && (C = this.sphereConvex(t, e.pillarConvex, i, f, n, r, s, a, t, e, u));
...
t("../collision/ObjectCollisionMatrix")), l = t("../collision/OverlapKeeper"), h = t("../material/Material"), c = t("../material/ContactMaterial"), u = t("../objects/Body"), p = t("../utils/TupleDictionary"), d = t("../collision/RaycastResult"), y = (t("../collision/AABB"), 
t("../collision/Ray")), f = t("../collision/NaiveBroadphase");
if (i) {
i.doProfiling = !1;
i.DEBUG = !0;
} else if (window) {
...
this.broadphase = void 0 !== t.broadphase ? t.broadphase : new f();
this.bodies = [];
...
i = i || 10;
e = e || 0;
0 != this.substeps && (b = this.contacts.slice());
if (0 === e) {
this.internalStep(t);
this.time += t;
this.substeps = 1;
...
this.dt = t;
var e, i = this.contacts, o = _, n = B, r = this.numObjects(), s = this.bodies, a = this.solver, l = this.gravity, h = this.profile, c = u.DYNAMIC, p = this.constraints, d = x, y = l.x, f = l.y, v = l.z, m = 0;
doProfiling && (e = performance.now());
for (m = 0; m !== r; m++) {
if ((T = s[m]).useGravity && T.type === c) {
var g = T.force, w = T.mass;
g.x += w * y;
g.y += w * f;
g.z += w * v;
}
...
doProfiling && (h.broadphase = performance.now() - e);
var S = p.length;
for (m = 0; m !== S; m++) {
if (!(C = p[m]).collideConnected) for (var E = o.length - 1; E >= 0; E -= 1) if (C.bodyA === o[E] && C.bodyB === n[E] || C.bodyB === o[E] && C.bodyA === n[E]) {
o.splice(E, 1);
n.splice(E, 1);
}
}
...
doProfiling && (h.narrowphase = performance.now() - e);
doProfiling && (e = performance.now());
...
a.solve(t, this);
doProfiling && (h.solve = performance.now() - e);
...
if (V) {
var I = P(1 - T.angularDamping, t);
V.mult(I, V);
}
}
}
doProfiling && (e = performance.now());
var O = this.stepnumber % (this.quatNormalizeSkip + 1) == 0, k = this.quatNormalizeFast;
for (m = 0; m !== r; m++) s[m].integrate(t, O, k);
this.clearForces();
this.broadphase.dirty = !0;
doProfiling && (h.integrate = performance.now() - e);
this.time += t;
this.stepnumber += 1;
...
if (this.collisionMatrix.get(a, l)) w.event = "collision-stay"; else {
this.collisionMatrix.set(a, l, !0);
w.event = "collision-enter";
}
if (DEBUG) {
w.bi = a;
w.contact = e[0];
...
w.selfShape = n;
w.otherShape = r;
n.body.dispatchEvent(w);
w.body = n.body;
w.selfShape = r;
w.otherShape = n;
r.body.dispatchEvent(w);
}
}
var h = b;
for (o = h.length; o--; ) {
